...
return [
    ...
    'password' => [
        ...
        'uncompromised' => "La valeur saisie pour :attribute a été trouvée dans une fuite de données. Merci de choisir une autre valeur pour :attribute.",
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Libellés lisibles pour les champs de formulaire
    |--------------------------------------------------------------------------
    */
    ...
    'attributes' => [
        ...
        'company_sigle' => 'sigle',
        'company_tax_id' => 'numéro d’identification fiscale (NIF)',
        'company_logo' => 'attestation DFE / NIF',
        'sector' => "secteur d'activité",
        'rccm' => 'numéro RCCM / SIRET',
