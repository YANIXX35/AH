    ...
    <div class="row g-3">
        <div class="col-12 col-xl-8">
            <div class="crypto-card">
                <div class="card-body">
                    <h5 class="mb-3">Formulaire de modification</h5>
                        ...
                        <div class="row g-3 mb-1">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="transaction_type" name="transaction_type" class="form-select @error('transaction_type') is-invalid @enderror" required>
                                    <option value="">Sélectionner...</option>
                                    <option value="Paiement client" {{ old('transaction_type', $transaction->transaction_type) === 'Paiement client' ? 'selected' : '' }}>Paiement client</option>
                                    <option value="Paiement fournisseur" {{ old('transaction_type', $transaction->transaction_type) === 'Paiement fournisseur' ? 'selected' : '' }}>Paiement fournisseur</option>
                                    <option value="Frais bancaires" {{ old('transaction_type', $transaction->transaction_type) === 'Frais bancaires' ? 'selected' : '' }}>Frais bancaires</option>
                                    <option value="Versement" {{ old('transaction_type', $transaction->transaction_type) === 'Versement' ? 'selected' : '' }}>Versement</option>
                                    <option value="Retrait" {{ old('transaction_type', $transaction->transaction_type) === 'Retrait' ? 'selected' : '' }}>Retrait</option>
                                    <option value="Intérêts" {{ old('transaction_type', $transaction->transaction_type) === 'Intérêts' ? 'selected' : '' }}>Intérêts</option>
                                    <option value="Autre" {{ old('transaction_type', $transaction->transaction_type) === 'Autre' ? 'selected' : '' }}>Autre</option>
                                </select>
